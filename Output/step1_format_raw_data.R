...
###https://opc.dataone.org/view/doi:10.25494/P6/MLPA_kelpforest.4

##require:

#MLPA_kelpforest_swath.4.csv
#MLPA_kelpforest_upc.4.csv
#MLPA_kelpforest_fish.4.csv
#MLPA_kelpforest_site_table.4.csv
#MLPA_kelpforest_taxon_table.4.csv
...
kelp_fish_counts_raw <- read.csv(file.path(basedir, "MLPA_kelpforest_fish.4.csv")) %>%
  janitor::clean_names()

kelp_upc_raw <- read.csv(file.path(basedir, "MLPA_kelpforest_upc.4.csv")) %>%
  janitor::clean_names()
  
kelp_swath_raw <- read.csv(file.path(basedir, "MLPA_kelpforest_swath.4.csv")) %>%
  janitor::clean_names()

kelp_taxon <- read.csv(file.path(basedir, "MLPA_kelpforest_taxon_table.4.csv")) %>%
  janitor::clean_names() %>%
  dplyr::select(classcode, species_definition) %>%
  distinct()

site_table <- read.csv(file.path(basedir, "MLPA_kelpforest_site_table.4.csv")) %>%
  janitor::clean_names() %>%
